...
// in for-of loop getting the index isn't an easy process
// we use entries() method which gives an array of arrays
// the array is a pair of the index and the value at that index

for (const item of menu.entries()) {
  console.log(`${item[0] + 1}: ${item[1]}`);
}

// re-writing the above code using array destructuring
